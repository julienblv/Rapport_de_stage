...
<br/>
    <div class='liens'>    
    <li id='liens'><a  class="colotxttab" href="http://localhost/cpam_pca/Numeros_importants.json" download>Téléchargez le Json ici</a></li>
           
            <li id='liens'><a  class="colotxttab" href="http://localhost/cpam_pca/Login.php"> Deconnexion ?</a></li>
        
    <li id='liens'><a class="colotxttab" href="http://localhost/cpam_pca/convertcsv.CSV" download>Téléchargez le CSV ici</a></li>
    <br/>
    </div>
...
?>
        <form method="POST" action="http://localhost/cpam_pca/Show.php?id='<?php $resultat['id']?>'"> 
...
if ($_SESSION['admin']=="yes"){
    echo 
    "<td class='container'><form method='POST' action='http://localhost/cpam_pca/Modif.php?id='".$_POST['id']."'>
    <input type='submit' class='btn btn-default btn-lg' value='Modifier ?'/></td></a>
    </form>

    <td>
    <form method='POST' action='http://localhost/cpam_pca/Delete.php?id='".$_POST['id']."'>
