...
<form method="POST" action="http://localhost/cpam_pca/Modif.php">
...
if(isset($_POST['push'])){
        ...
        echo"<li><a href='http://localhost/cpam_pca/Annuaire.php'>Cliquez ici pour retourner sur la liste</a></li>";
        }
...
<div>
<input type="Submit" value="supprimer le contact" name ="DEL">

<?php
if(isset($_POST['DEL'])){
$req=$dbh->query("DELETE FROM annuaire_comite_alerte WHERE id like '$id'");
echo"succes! contact deleted";
}
else{
    echo "deleting error retry or contact the support ";
}
?>
