...
<div class="container-fluid">
    ...
    <div class="liens">
        ...
        <li id='liens'><a class="colotxttab" href="http://localhost/cpam_pca/Modif.php"> Modifier le contact ?</a></li>
        <li id='liens'><a class="colotxttab" href="http://localhost/cpam_pca/Annuaire.php"> Retour à la liste ?</a></li>
        <br/>
    </div>
...
<form method="POST" action="http://localhost/cpam_pca/Modif.php?id='<?php $_POST['id']?>'"> 
